...
@endsection
@section('content3')
    <a href="{{route('reference.systemtypes')}}" class="btn btn mt-3"><i class="fas fa-arrow-circle-left"></i> Back to System Type</a>
    ...
    @endif
    <h5 class="border-bottom">Search Result(s) for System Type</h5>
