...
@endsection
@section('content3')
    <a href="{{route('reference.faultcodes')}}" class="btn mt-3"><i class="fas fa-arrow-circle-left"></i> Back to Fault Code</a>
    ...
    @endif
    <h5 class="border-bottom">Search Result(s) for Fault Code</h5>
