...
@endsection
@section('content3')
    <a href="{{route('reference.customers')}}" class="btn btn mt-3"><i class="fas fa-arrow-circle-left"></i> Back to Customer List</a>
    ...
    @endif
    <h5 class="border-bottom">Customer Search Result(s)</h5>
