...
@section('content3')
    ...
    <div class="row">
        <div class="col-6">
            <form action="{{route('reference.unit.store')}}" method="post">
                @csrf
                <div class="card">
                    <div class="card-body shadow-sm">
                        <h5 class="border-bottom">Create New Unit</h5>
                        ...
                        <button type="submit" class="btn btn-success form-control">Add New Unit</button>
                    </div>
                </div>
            </form>
        </div>
