...
@endsection
@section('content3')
    <a href="{{route('reference.boardtypes')}}" class="btn btn mt-3"><i class="fas fa-arrow-circle-left"></i> Back to Board Type</a>
    ...
    @endif
    <h5 class="border-bottom">Search Result(s) for Board Type</h5>
