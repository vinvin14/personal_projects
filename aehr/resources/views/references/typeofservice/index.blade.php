...
@endsection
@section('content3')
    <a href="{{route('reference.typeofservice.create')}}" class="btn btn-primary mt-3 shadow">Add Type Of Service</a>
    ...
    @endif
    <form action="{{route('reference.typeofservice.search')}}" method="get">
