...
@endsection
@section('content3')
    <a href="{{route('consumables')}}" class="btn btn-outline mt-1"><i class="fas fa-arrow-circle-left"></i> Back to
        Consumables</a>
    <div class="row">
        <div class="col-6">
            <div class="card shadow-sm">
                <div class="card-body ">
                    ...
                    <a href="{{route('consumable.update', $data['data']->id)}}"
                                    ...
                                    <li class="list-group-item list-group-item-action mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-2 ext-right my-3">
                                                <a href="{{route('movement.consumable.show', $incoming->id)}}"
                                                   class="">View</a>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item list-group-item-action mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-2 ext-right my-3">
                                                <a href="{{route('movement.consumable.show', $outgoing->id)}}"
                                                   class="">View</a>
                                            </div>
                                        </div>
                                    </li>
