...
@section('content3')
    ...
    <div class="card w-50 shadow-sm mb-4">
        <div class="card-body ">
            ...
            <form action="{{route('component.upsave', $data['components']->id)}}" method="post">
                @csrf
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="text" name="description" class="form-control"
                                   value="{{$data['components']->description}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="text" name="partNumber" class="form-control"
                                   value="{{$data['components']->partNumber}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="text" name="referenceDesignator" class="form-control"
                                   value="{{$data['components']->referenceDesignator}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                            ...
                            {{--<select name="systemType" id="" class="form-control">--}}
                                {{--@foreach ($data['systemTypes'] as $systemType)--}}
                                    {{--<option value="{{$systemType['id']}}"--}}
                                            {{--@if($data['components']->systemTypeID == $systemType['id'])--}}
                                            {{--selected--}}
                                        {{--@endif--}}
                            ...
                            {{--<select name="boardType" id="" class="form-control">--}}
                                {{--@foreach ($data['boardTypes'] as $boardType)--}}
                                    {{--<option value="{{$boardType['id']}}"--}}
                                            {{--@if($data['components']->boardTypeID == $boardType['id'])--}}
                                            {{--selected--}}
                                        {{--@endif--}}
                            ...
                            <select name="storedIn" id="" class="form-control">
                                @foreach ($data['storedIn'] as $location)
                                    <option value="{{$location['id']}}"
                                            @if($data['components']->storedInID == $location['id'])
                                            selected
                                        @endif
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="text" name="location" id="" class="form-control"
                                   value="{{$data['components']->location}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="number" name="maximumQuantity" id="maximumQuantity" class="form-control"
                                   value="{{$data['components']->maximumQuantity}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="number" name="actualQuantity" id="actualQuantity" class="form-control"
                                   value="{{$data['components']->actualQuantity}}" @if(! empty($data['has_movement'])) readonly @endif>
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="number" name="minimumQuantity" id="minimumQuantity" class="form-control"
                                   value="{{$data['components']->minimumQuantity}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                            ...
                            <select name="unit" id="" class="form-control">
                                @foreach ($data['units'] as $unit)
                                    <option value="{{$unit['id']}}"
                                            @if($data['components']->unitID == $unit['id'])
                                            selected
                                        @endif
                                    >{{$unit['unit']}}</option>
                                @endforeach
                ...
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="number" name="unitPrice" id="unitPrice" step="0.1" class="form-control"
                                   value="{{$data['components']->unitPrice}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="number" name="totalPrice" id="totalPrice" step="0.1" class="form-control"
                                   value="{{$data['components']->totalPrice}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <input type="date" name="dateReceived" id="dateReceived" class="form-control"
                                   value="{{$data['components']->dateReceived}}">
                        </div>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-8 text-left">
                        <div class="text-info">
                            <textarea name="remarks" id="" cols="30" rows="10"
                                      class="form-control">{{$data['components']->remarks}}</textarea>
                        </div>
                    </div>
                </div>
