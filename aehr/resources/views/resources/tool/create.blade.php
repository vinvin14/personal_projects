    ...
    <div class="row mb-3">
        <div class="col-6 border-right">
            <div class="card card-body shadow-sm">
                ...
                @endif
                <h5 class="border-bottom">Create new Tool</h5>
                <form action="{{route('tool.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="actualQuantity" id="actualQuantity" value="1" class="form-control" readonly>
                    </div>
                    {{--<div class="form-group">--}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="usefulLife" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="calibrationReq">
                        <label class="font-weight-bold" for="">Calibration Requirement</label>
                        <textarea name="calibrationReq" id="" cols="1" rows="1" class="form-control"></textarea>
                    </div>
                    <div class="form-group" id="calibrationDate">
                        <label class="font-weight-bold" for="">Calibration Date</label>
                        <input type="date" name="calibrationDate" class="form-control">
                    </div>
                    ...
                    <button type="submit" class="btn btn-success form-control">Save new Tool</button>
                </form>
            </div>
        </div>
        <div class="col-6">
            <div class="card card-body shadow-sm">
                <div style="overflow-y: auto; max-height: 600px !important;">
                    <h5 class="border-bottom pl-2">Existing Tool(s)</h5>
                    <div class="p-2">
