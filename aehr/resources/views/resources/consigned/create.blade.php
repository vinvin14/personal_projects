...
@endsection
@section('content3')
    <a href="{{route('consigned')}}" class="btn btn-outline mt-1"><i class="fas fa-arrow-circle-left"></i> Back to Consigned Spares</a>
    <div class="row mb-3">
        <div class="col-6 border-right">
            <div class="card card-body shadow-sm">
                ...
                @endif
                <h5 class="border-bottom">Create new Consigned Spare</h5>
                <form action="{{route('consigned.store')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" name="depreciationValue" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success form-control">Save Consigned Spare</button>
                </form>
            </div>
        </div>
        <div class="col-6">
            <div class="card card-body shadow-sm">
                <div style="overflow-y: auto; max-height: 600px !important;">
                    <h5 class="border-bottom pl-2">Existing Consigned Spare(s)</h5>
                    <div class="p-2">
