...
@section('content3')
    {{--{{dd($data)}}--}}
    <a href="{{route('consigned.collection.show', $data['data']->partNumber)}}" class="btn btn-outline mt-1"><i
            class="fas fa-arrow-circle-left"></i> Back to
        Consigned Spares</a>
    <div class="row">
        <div class="col-6">
            <div class="card shadow-sm mb-4">
                <div class="card-body ">
                    ...
                    <a href="{{route('consigned.update', $data['data']->id)}}" class="btn btn-success float-right mt-1">Update
                        Information</a>
                </div>
            </div>
        </div>
                                    ...
                                    <li class="list-group-item list-group-item-action mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-2 ext-right my-3">
                                                <a href="{{route('movement.consigned.show', $incoming->id)}}"
                                                   class="">View</a>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item list-group-item-action mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-2 ext-right my-3">
                                                <a href="{{route('movements.consigned.show', $outgoing->id)}}"
                                                   class="">View</a>
                                            </div>
                                        </div>
                                    </li>
