...
@section('content3')
    ...
    @endif
    <a href="{{route('movement.tool.create')}}" class="btn btn-primary my-2 shadow">Item Movement for Tools</a>
                ...
                <table class="table table-bordered shadow-sm">
                    ...
                    @foreach($data['incoming'] as $incoming)
                        <tr>
                            ...
                            <td>{{ucfirst($incoming->description)}} | {{strtoupper($incoming->partNumber)}} | {{strtoupper($incoming->modelNumber)}}</td>
                                ...
                                <div class="float-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                            <a class="dropdown-item" href="{{route('movement.tool.show', $incoming->id)}}"
                                               type="button"><i class="fas fa-eye text-primary"></i> View</a>
                                            <a class="dropdown-item"
                                               href="{{route('movement.tool.update' , $incoming->id)}}"><i
                                                    class="fas fa-edit "></i> Edit</a>
                                            <a class="dropdown-item" onclick="return confirm('Are you sure you want to revert this movement?')"
                                               href="{{route('movement.tool.revert' , $incoming->id)}}" type="button"><i class="fas fa-recycle"></i> Revert</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
