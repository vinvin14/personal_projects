...
@section('content3')
    ...
    @endif
    <a href="{{route('movement.component.create')}}" class="btn btn-primary my-2 shadow">Item Movement for Components</a>
                                ...
                                <div class="float-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                            <a class="dropdown-item" href="{{route('movement.component.show', $incoming->id)}}"
                                               type="button"><i class="fas fa-eye text-primary"></i> View</a>
                                            <a class="dropdown-item"
                                               href="{{route('movement.component.update' , $incoming->id)}}"><i
                                                    class="fas fa-edit "></i> Edit</a>
                                            <a class="dropdown-item" onclick="return confirm('Are you sure you want to revert this movement?')"
                                               href="{{route('movement.component.revert' , $incoming->id)}}" type="button"><i class="fas fa-recycle"></i> Revert</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
