    ...
    <div class="row">
        <div class="col-6">
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    ...
                    @endif
                    <h5 class="border-bottom">Create New Movement For Components</h5>
                    <form action="{{route('movement.component.store')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group" id="outgoing-referencedesignator">
                            <label class="font-weight-bold" for="">Reference Designator</label>
                            <input type="text" class="form-control" name="reference_designator">
                        </div>
                        <div class="form-group" id="components">
                            <label class="font-weight-bold" for="">Component</label>
                            <select name="reference" id="" class="form-control">
                                <option value="">-</option>
                                @foreach($data['data'] as $component)
                                    <option value="{{$component['id']}}">
                                        {{$component['partNumber']}} | {{$component['description']}}
                                        (<strong class="text-info">{{$component['actualQuantity']}}</strong>)
                                    </option>
                                @endforeach
                            </select>
                        </div>
        ...
        <div class="col-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h5 class="border-bottom">Component(s)</h5>
                    @foreach($data['data'] as $component)
                        <ul class="list-group">
...
@endif
                                ...
                                </strong>) <span class="text-info">  <small>Current Unit Price:</small> <strong>${{$component['unitPrice']}}</strong></span>
